...
<template>
	<nav
		...
		class="[ fixed w-full top-0 z-30 flex justify-end pb-4 py-5 ] [ text-primary transition-all duration-500 backdrop-blur-sm ]"
		:class="{ 'bg-bg-theme-dark/20 ': solidNav }"
	>
